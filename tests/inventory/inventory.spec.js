...
test('Verify user can open a product detail page', async ({page}) => {
...
test('Verify one product can be added to cart', async ({page}) => {
    await page.goto('/inventory.html')
...
test('Remove single item from inventory page', async ({page}) => {
    await page.goto('/inventory.html')
